...
const Signup = () => {
  ...
  useEffect(() => {
    ...
    // start or keep running the interval
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            Join thousands dominating the dating game with AI-powered insights
          </p>
        </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                // only lock phone while cooldown is active
            ...
            <button
              type="submit"
              disabled={signingUp || (!otpSent && !phone)}
